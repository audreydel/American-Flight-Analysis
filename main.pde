...
Widget homeScreen, homeLogo, emptyWidget, graph1, pieChart, graph3, rightArrow, leftArrow, lateWidget, airportWidget, oStateWidget, dStateWidget,
...
void setup() {
  ...
  fill(255);
  stdFont=loadFont("RockwellNova-20.vlw");
  ...
  lateWidget=new Widget(0, 170, 200, 55,
    "Lateness", headColor,
    stdFont, LATE_BUTTON);
  airportWidget=new Widget(0, 220, 200, 55,
    "Airport", headColor,
    stdFont, AIRPORT_BUTTON);
  oStateWidget=new Widget(0, 270, 200, 55,
    "Origin State", headColor,
    stdFont, O_STATE_BUTTON);
  dStateWidget=new Widget(0, 320, 200, 55,
    "Destination State", headColor,
    stdFont, D_STATE_BUTTON);
  ...
  graphButtonList=new ArrayList();
  //emptyWidgetList=new ArrayList();
  
  widgetList1.add(homeScreen);
  
  graphButtonList.add (lateWidget);
  graphButtonList.add (airportWidget);
  graphButtonList.add (oStateWidget);
  graphButtonList.add (dStateWidget);
  ...
  screen1=new Screen(backgroundCol,calList,widgetList1, fakeList);
  screen2=new Screen(backgroundCol,widgetList1,graphButtonList, fakeList);
  screen3=new Screen(backgroundCol,widgetList1, graphButtonList, widgetList2); //,widgetList2
  screen4=new Screen(backgroundCol,widgetList1,graphButtonList, fakeList);
  introScreen=new Screen(backgroundCol,fakeList, fakeList, fakeList);
  //mainPage=new Screen(widgetList1, fakeList);
  screen5=new Screen(backgroundCol,widgetList1,widgetList2,graphButtonList);
...
void draw() {
  ...
  if (currentScreen == screen2){
    for(int i = 0; i < graphButtonList.size(); i++){
      Widget aWidget = (Widget) graphButtonList.get(i);
      aWidget.draw();
    }
  }
